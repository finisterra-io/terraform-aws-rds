...
| <a name="input_instance_identifier_prefix"></a> [instance\_identifier\_prefix](#input\_instance\_identifier\_prefix) | The name which is prefixed to the RDS instance | `string` | `null` | no |
...
| <a name="input_option_group_tags"></a> [option\_group\_tags](#input\_option\_group\_tags) | Additional tags for the DB option group | `map(string)` | `{}` | no |
